...
const Header = () => {
    ...
    const {setIndicator,indicator} = IndicatorData() 
        ...
        <header style={{
            ...
            <div style={{display:'flex',justifyContent:'space-between',gap:'20px'}}>
                ...
                <div className='headerpointer' style={{display:'flex',alignItems:'center',gap:'8px'}}>
                    ...
                    <div onClick={()=>window.open("https://www.airtel.in/digital-store/sku-details/?skuGroupId=WYNK", '_blank')}>
                        <p>
                            Manage Subscription
                        </p>
                    </div>
                </div>
                <div style={{borderLeft:'2px solid hsla(0,0%,100%,.2)'}}></div>
                {!apiData?.email&&<div onClick={()=>setIndicator((prev)=>({...prev,loginIndicator:true}))} className='headerpointer' style={{display:'flex',gap:'8px',alignItems:'center'}}>
                    <div style={{marginTop:'5px'}}>
                ...
                {apiData?.email&&<div onClick={()=>navigate('/my-music/my-playlists')} className='headerpointer' style={{display:'flex',gap:'8px',alignItems:'center'}}>
                    <div style={{marginTop:'5px'}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none"><path d="M6.37001 21.5383C7.77833 21.5383 8.92001 20.4011 8.92001 18.9983C8.92001 17.5954 7.77833 16.4583 6.37001 16.4583C4.96168 16.4583 3.82001 17.5954 3.82001 18.9983C3.82001 20.4011 4.96168 21.5383 6.37001 21.5383Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M8.91003 18.9982V6.57825" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17.63 17.9982C19.0383 17.9982 20.18 16.861 20.18 15.4582C20.18 14.0554 19.0383 12.9182 17.63 12.9182C16.2216 12.9182 15.08 14.0554 15.08 15.4582C15.08 16.861 16.2216 17.9982 17.63 17.9982Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M20.1801 15.4582V3.03821" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M8.91003 6.57821L20.18 3.03821" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.22998 10.4181L20.18 6.97815" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                    </div>
                    <div>
                        <p>My Music</p>
                    </div>
                ...
                <div style={{display:'flex',alignItems:'center',marginBottom:'25px'}}>
                    <div>
                        <div onClick={(e)=>handleMenuButtonClick(e)} style={{position:'absolute',cursor:'pointer'}}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none"><path d="M3.75 12.1211H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M3.75 6.12109H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M3.75 18.1211H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        </div>
                        {open&&<div id='menu' style={{display:'inline-block',position:'absolute',width:'250px',right:apiData?.email?'50px':'75px',marginTop:'57px',zIndex:10000}}>
                            <DropDownMenu setOpen={setOpen} authData={apiData} />
                        </div>}
                    </div>
                </div>
            </div>
          {indicator?.searchIndicator&&<SearchPage setSearch={setSearch} searchInput={Search} />}
        </header>
    )
}
